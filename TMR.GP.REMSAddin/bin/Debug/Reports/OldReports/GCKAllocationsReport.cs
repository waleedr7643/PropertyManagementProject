...
namespace TMR.GP.REMSAddin.Reports.OldReports {
    ...
    public class GCKAllocationsReport : ReportClass {
        
        public GCKAllocationsReport() {
        }
        
        public override string ResourceName {
            get {
                return "GCKAllocationsReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TMR.GP.REMSAddin.Reports.OldReports.GCKAllocationsReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedGCKAllocationsReport : Component, ICachedReport {
        
        public CachedGCKAllocationsReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            GCKAllocationsReport rpt = new GCKAllocationsReport();
            rpt.Site = this.Site;
            return rpt;
        }
