    ...
    public partial class frmUnit : Form
    {
        ...
        private void LoadGrid()
        {
            ...
            foreach (clsUnit unit in units)
            {
                ...
                dgList.Rows[intRowIndex].Cells["UomID"].Value = unit.strUOMID.ToUpper();
                ...
                dgList.Rows[intRowIndex].Cells["SquareFeets"].Value = unit.decSquareFeet.ToString("N2");
        ...
        private void dgList_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtSquareFeets.Text = dgList.Rows[intRowIndex].Cells["SquareFeets"].Value.ToString();
        ...
        private void txtWidth_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            //if (e.KeyChar == '.' && txtWidth.Text.Contains("."))
            //{
            //    e.Handled = true;
            //}
            ...
            //    e.Handled = true;
            //}
            //if (e.KeyChar == '.' && txtSquareFeets.Text.Contains("."))
            //{
            //    e.Handled = true;
            //}
        }
        ...
        private void txtWidth_Leave(object sender, EventArgs e)
        {
            ...
            txtSquareFeets.Text = (width * length).ToString();
        }
