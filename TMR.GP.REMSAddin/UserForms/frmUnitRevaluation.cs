...
namespace TMR.GP.REMSAddin
{
    public partial class frmUnitRevaluation : Form
    {
        ...
        private void tsbSave_Click(object sender, EventArgs e)
        {
            ...
            if (id == 0)
            {
                revaluation.CreatedBy = Microsoft.Dexterity.Applications.Dynamics.Globals.UserId;
            ...
            else if (id != 0)
            {
                ...
                revaluation.LastUpdateUser = Microsoft.Dexterity.Applications.Dynamics.Globals.UserId;
                revaluation.ApprovalActionUser = "";
                revaluation.ApprovalActionDate = new DateTime(1900, 1, 1);
            }
            int intRevalID = 0;
