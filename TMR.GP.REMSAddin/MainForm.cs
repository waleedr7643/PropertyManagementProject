...
namespace TMR.GP.REMSAddin
{
    public partial class MainForm : Form
    {
        ...
        public static frmReceiptEntry _receiptEntry;
        ...
        {
            frmRecoveryTypes recoveryType = new frmRecoveryTypes();
            recoveryType.Show();
        }

        private void linkLabel11_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmOtherRecoveryPlan recoveryType = new frmOtherRecoveryPlan();
            recoveryType.Show();
        }

        private void linkLabel12_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (_receiptEntry == null || _receiptEntry.IsDisposed == true)
            {
                _receiptEntry = new frmReceiptEntry();
                //__frmGPR.lable = "Allocation Report";
                _receiptEntry.Show();
            }
            _receiptEntry.BringToFront();
        }
    }
}
