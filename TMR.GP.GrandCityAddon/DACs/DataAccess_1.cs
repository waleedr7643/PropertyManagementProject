...
namespace TMR.GP.GrandCityAddon
{
    ...
    public partial class DataAccess
    {
        ...
        public SqlConnectionStringBuilder GetCredentials()
        {
            try
            {
                SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder(ConfigurationManager.ConnectionStrings["TestDB"].ConnectionString);
                return builder;
            }
            catch (Exception)
            {
        ...
        public SqlConnectionStringBuilder GetGPCredentials()
        {
            try
            {
                SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder(ConfigurationManager.ConnectionStrings["GASMC"].ConnectionString);
                return builder;
            }
            catch (Exception)
            {
