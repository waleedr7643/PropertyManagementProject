...
{    
    public partial class frmUnitsLookUp : Form
    {
        ...
        private void PopulateGrid()
        {
            ...
            var list = da.GetAvailableUnitsByProjectBlockSizeCode(strProjectID, strBlockNo, strSizeCode);
            ...
            foreach (var item in list)
            {
                ...
                //dgList.Rows[rowIndex].Cells["id"].Value = item.ID.ToString();
                //dgList.Rows[rowIndex].Cells["Plot"].Value = item.strPlotNo;
            }
        }
