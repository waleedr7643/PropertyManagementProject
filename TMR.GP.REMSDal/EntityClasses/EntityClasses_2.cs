...
namespace TMR.GP.REMSDal
{
    ...
    public class clsUnit
    {
        ...
        public string strSBStreet { get; set; }
        public string strSBBlock { get; set; }
    ...
    public class clsInstallmentPlan
    {
        ...
        public int intInstallmentStartAfter { get; set; }
        public bool bInactive { get; set; }
        public int intInstallmentFrequency { get; set; }
        public int intNoOfInstallments { get; set; }
        public decimal decInstallmentAmount { get; set; }
    ...
    public class clsInstallmentPlanDetails
    {
        ...
        public decimal decInstallmentPercentage { get; set; }
