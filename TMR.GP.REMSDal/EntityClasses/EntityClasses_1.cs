...
namespace TMR.GP.REMSDal
{
    ...
    public class clsMemberRegistration
    {
        ...
        public decimal UnitAdditionPerc { get; set; }
        public decimal UntiAdditionalCharges { get; set; }
        ...
        public string strInstallmentPlan { get; set; }
        public string strCustomerClass { get; set; }
        public int intInstallmentCount { get; set; }
        public int intInstallmentFrequency { get; set; }
        public string strInstallmentPlanType { get; set; }
        public DateTime dateInstallmentStartDate { get; set; }
        public string strSalesRep { get; set; }
        public decimal decSalesRepPercentage { get; set; }
        public string strDealer { get; set; }
        public decimal decDealerPercentage { get; set; }
        public string strSubDealer { get; set; }
        public decimal decSubDealerPercentage { get; set; }
